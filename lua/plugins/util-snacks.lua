...
return {
  ...
  opts = {
    ...
    statuscolumn = { enabled = true }, -- improve signs next to number columnt
    words = { enabled = true }, -- highlight word under coursor
  },
  -- stylua: ignore
  keys = {
    -- Top Pickers & Explorer
    { "<leader><space>", function() Snacks.picker.files({submodules=false, hidden=true, ignored=true, exclude={"target"}}) end, desc = "Smart Find Files" },
    ...
    -- { "<leader>fs", function() Snacks.picker.smart() end, desc = "Buffers" },
